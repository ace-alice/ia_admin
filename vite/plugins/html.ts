...
if ((navigator.language || navigator.browserLanguage).toLowerCase() === 'zh-cn') {
  console.info('%c由%cIA-Esport%c驱动', '${copyright_sub_style}', '${copyright_main_style}', '${copyright_sub_style}', '\\nhttps://demo.ilustretest.com');
} else {
  console.info('%cPowered by%cIA-Esport', '${copyright_sub_style}', '${copyright_main_style}', '\\nhttps://demo.ilustretest.com');
}
</script>
    `
  }
