...
import Api from '@/api/financial-manage/game-report'
...
const defaultCrudOptions: CrudOptionsType = {
  crudTitle: i18n.global.t('router.game-report'),
  defaultQuery: {
    game_type_id: null,
    event_id: null,
    game_id: null,
    ...
    settle_start_time_start: dayjs().subtract(1, 'day').startOf('day').unix(),
    settle_start_time_end: dayjs().endOf('day').unix(),
    category_id: null,
    is_champion: null,
    proxy_id: null,
    company_id: null,
  ...
  >
    <template #searchBox>
      <el-form :inline="true" :model="crudQuery" label-width="120px">
        ...
        <el-form-item :label="$t('table.bet_settlement_time')">
          <dateTimePickerQuery
            start-key="settle_start_time_start"
            end-key="settle_start_time_end"
            :prop-time="[
              crudQuery.settle_start_time_start,
              crudQuery.settle_start_time_end,
            ]"
            @set-time="crudSetQueryKey"
          />
        </el-form-item>
    ...
    <template #pageBody>
      ...
      >
        ...
        />
        <el-table-column
          prop="monitor_admin_name"
          :label="$t('table.monitor_admin_name')"
          width="140"
          align="center"
        />
      </el-table>
